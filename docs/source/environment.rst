...
Перед импортом категории в Renga три подготовленных файла должны быть скомпилированы в один файл с расширением ``.rtc`` (*Renga Template Category* - шаблон категории Renga).
...
Импорт нового шаблона категории пользовательского оборудования в Renga осуществляется из меню "Управление стилями" — "Категории".
