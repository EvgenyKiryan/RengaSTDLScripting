...
.. important:: Данное обучающее руководство рассчитано на специалистов, имеющих навыки программирования и способных самостоятельно сконфигурировать рабочие инструменты для создания шаблона. Цель руководства — познакомить с возможностями встроенных функции Lua в рамках создания шаблона категории Renga.
...
Для создания данного примера было использовано следующее программное обеспечение:

- Текстовый редактор `Visual Studio Code <https://code.visualstudio.com/>`_ для создания ``parameters.json`` и ``main.lua``;
- Графический редактор `Krita <https://krita.org/en/>`_ для создания ``graph_icon.svg``.

Импорт подготовленного шаблона оборудования, скомпилированного в файл ``*.rtc``, возможен в `Renga <https://rengabim.com/>`_ версии 6.0 (и старше).
...
Размеры обозначения на видах примем:

- для условного отображения — размер символа будет соответствовать габаритному размеру оборудования;
- для символьного отображения — размер символа будет равен 1,2 см (ширина) х 1,0 см (высота).
